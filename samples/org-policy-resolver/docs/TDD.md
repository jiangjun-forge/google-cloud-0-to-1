...
# 기술 상세 설계서 (TDD): GCP 조직 정책(Organization Policy) 위반 감사 역추적 및 복구 (`org-policy-resolver`)
...
| :--- | :--- | :--- |
| **NFR-01** | **최소 IAM 권한 준수** | 진단에 필요한 최소 권한(`roles/logging.viewer, roles/orgpolicy.policyAdmin`)만을 요구하며, 불필요한 쓰기 권한을 강제하지 않는다. |
